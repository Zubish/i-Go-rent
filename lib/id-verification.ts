...
export async function verifyNIN(nin: string): Promise<IDVerificationResponse> {
  try {
    ...
    const response = await fetch("https://api.govt-id-verification.ng/nin/verify", {
      method: "POST",
      headers: {
...
export async function verifyDriversLicense(
  ...
  try {
    const response = await fetch("https://api.govt-id-verification.ng/drivers-license/verify", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.GOVT_ID_API_KEY}`,
...
export async function verifyIntlPassport(passportNumber: string): Promise<IDVerificationResponse> {
  try {
    const response = await fetch("https://api.govt-id-verification.ng/passport/verify", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.GOVT_ID_API_KEY}`,
...
export async function verifyBVN(bvn: string): Promise<IDVerificationResponse> {
  try {
    const response = await fetch("https://api.govt-id-verification.ng/bvn/verify", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.GOVT_ID_API_KEY}`,
...
// CAC Verification
export async function verifyCAC(cacNumber: string): Promise<IDVerificationResponse> {
  try {
    const response = await fetch("https://api.govt-id-verification.ng/cac/verify", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${process.env.GOVT_ID_API_KEY}`,
