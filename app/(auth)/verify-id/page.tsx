...
export default function VerifyIDPage() {
  ...
  const [idType, setIdType] = useState<"nin" | "drivers_license" | "intl_passport" | "bvn" | "cac">("nin")
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <div className="p-8">
          <h1 className="text-2xl font-bold mb-2">Government ID Verification</h1>
          <p className="text-gray-600 mb-8">Verify your identity to unlock all features</p>
          ...
          <p className="text-sm text-gray-500 mt-6 text-center">
            Your information is secure and encrypted. We verify against official government databases.
          </p>
        </div>
      </Card>
    </div>
